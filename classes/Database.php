...
abstract class Database {
    ...
    function __construct($host = "host", $user = "user", $password = "password", $database = "database") {
        ...
        $this->sqli = new mysqli($this->credentials["host"], $this->credentials["user"], $this->credentials["password"], $this->credentials["database"]);
    ...
    protected function SelectRows($table_name, array $selection, array $where_clause = NULL) {
    ...
    protected function InsertRows($table_name, array $columns, array $values) {
    ...
    protected function UpdateRows($table_name, array $set_assoc, array $where_assoc) {
